...
resource "aws_iam_role_policy" "ssm_parameters" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:ssm:${var.region}:${data.aws_caller_identity.current.account_id}:parameter/movies/*"
    }]
  })
}
